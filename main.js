...
function handleSubmit(e){
   ...
   //localStorage güncelleme
    setStorage(notes);
   //notları ekrana aktarabilmek için fonksiyona nots dizisini parametre olarak gönderdik
    renderNoteList(notes);
...
function handleClick(e){
    ...
    //güncellenicek elemanın id'sini öğrenme
    const id = e.target.parentElement.dataset.id;
    console.log(notes);
    if(e.target.id=="delete"){
        console.log("tıklanıldı");
        // id2sini bldiğimiz elemanı diziden kaldırma
